...
class V1alpha1RainbondApplicationConfig(object):
    ...
    openapi_types = {
        ...
        'group_name': 'str',
        'group_version': 'str',
        'ingress_http_routes': 'list[V1alpha1IngressHTTPRoute]',
        'ingress_stream_routes': 'list[V1alpha1IngressSreamRoute]',
    ...
    attribute_map = {
        ...
        'ingress_http_routes': 'ingress_http_routes',
        'ingress_stream_routes': 'ingress_stream_routes',
        'plugins': 'plugins',
        'template_version': 'template_version'
    }

    def __init__(self, annotations=None, app_config_groups=None, apps=None, group_key=None, group_name=None, group_version=None, ingress_http_routes=None, ingress_stream_routes=None, plugins=None, template_version=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._ingress_http_routes = None
        self._ingress_stream_routes = None
        self._plugins = None
        ...
        if app_config_groups is not None:
            self.app_config_groups = app_config_groups
        self.apps = apps
        self.group_key = group_key
        self.group_name = group_name
        self.group_version = group_version
        if ingress_http_routes is not None:
            self.ingress_http_routes = ingress_http_routes
        if ingress_stream_routes is not None:
            self.ingress_stream_routes = ingress_stream_routes
    ...
    def annotations(self):
        """Gets the annotations of this V1alpha1RainbondApplicationConfig.  # noqa: E501


        :return: The annotations of this V1alpha1RainbondApplicationConfig.  # noqa: E501
        :rtype: dict(str, str)
        """
    ...
    def annotations(self, annotations):
        """Sets the annotations of this V1alpha1RainbondApplicationConfig.


        :param annotations: The annotations of this V1alpha1RainbondApplicationConfig.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def ingress_http_routes(self):
        """Gets the ingress_http_routes of this V1alpha1RainbondApplicationConfig.  # noqa: E501


        :return: The ingress_http_routes of this V1alpha1RainbondApplicationConfig.  # noqa: E501
        :rtype: list[V1alpha1IngressHTTPRoute]
        """
        return self._ingress_http_routes

    @ingress_http_routes.setter
    def ingress_http_routes(self, ingress_http_routes):
        """Sets the ingress_http_routes of this V1alpha1RainbondApplicationConfig.


        :param ingress_http_routes: The ingress_http_routes of this V1alpha1RainbondApplicationConfig.  # noqa: E501
        :type: list[V1alpha1IngressHTTPRoute]
        """

        self._ingress_http_routes = ingress_http_routes

    @property
    def ingress_stream_routes(self):
        """Gets the ingress_stream_routes of this V1alpha1RainbondApplicationConfig.  # noqa: E501


        :return: The ingress_stream_routes of this V1alpha1RainbondApplicationConfig.  # noqa: E501
        :rtype: list[V1alpha1IngressSreamRoute]
        """
        return self._ingress_stream_routes

    @ingress_stream_routes.setter
    def ingress_stream_routes(self, ingress_stream_routes):
        """Sets the ingress_stream_routes of this V1alpha1RainbondApplicationConfig.


        :param ingress_stream_routes: The ingress_stream_routes of this V1alpha1RainbondApplicationConfig.  # noqa: E501
        :type: list[V1alpha1IngressSreamRoute]
        """

        self._ingress_stream_routes = ingress_stream_routes
