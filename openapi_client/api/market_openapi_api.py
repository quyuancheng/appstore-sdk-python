...
class MarketOpenapiApi(object):
    ...
    def get_app_plugin_list(self, market_domain, **kwargs):  # noqa: E501
        """应用插件列表  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_app_plugin_list(market_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_app_plugin_list_with_http_info(market_domain, **kwargs)  # noqa: E501

    def get_app_plugin_list_with_http_info(self, market_domain, **kwargs):  # noqa: E501
        """应用插件列表  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_app_plugin_list_with_http_info(market_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_app_plugin_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('market_domain' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `market_domain` when calling `get_app_plugin_list`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/app-server/openapi/apps/plugins', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_orgs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[V1Organization], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
