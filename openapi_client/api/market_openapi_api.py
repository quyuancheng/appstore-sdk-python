...
class MarketOpenapiApi(object):
    ...
    def get_user_app_temp_list(self, market_domain, **kwargs):  # noqa: E501
        """应用模版列表  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_app_temp_list(market_domain, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_user_app_temp_list_with_http_info(market_domain, **kwargs)  # noqa: E501

    def get_user_app_temp_list_with_http_info(self, market_domain, **kwargs):  # noqa: E501
        """应用模版列表  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_app_temp_list_with_http_info(market_domain, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_user_app_temp_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'market_domain' is set
        if self.api_client.client_side_validation and ('market_domain' not in local_var_params or  # noqa: E501
                                                        local_var_params['market_domain'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `market_domain` when calling `get_user_app_temp_list`")  # noqa: E501
